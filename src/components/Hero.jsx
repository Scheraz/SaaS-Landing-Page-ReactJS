...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16 sm:pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-slate-950">
      <div
        className="absolute inset-0 pointer-events-none transition-all duration-150 opacity-30"
        style={{
            ...
            <div>
              <div className="inline-flex items-center space-x-2 px-3 sm:px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700">
                ...
                <span className="text-xs sm:Text-sm text-blue-300">
                  Introducing CodeFlowAI
                </span>
              </div>

              <h1 className="text-5xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight xl:text-6xl lg:tracking-tight mb-4 sm:mb-6 animate-in slide-in-from-bottom duration-700 delay-100 leading-tight">
            ...
            <div className="relative bg-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-4 shadow-2xl border border-white/10">
              ...
              >
                <div className="flex items-center space-x-2 mb-2">
                  <div
                    className={`size-6 ${currentFloatingCard.iconColor} flex items-center justify-center text-sm font-bold `}
                  >
