    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <p className="text-gray-400 text-xl sm:text-xl max-w-2xl mx-auto">
            ...
            >
              ...
              {plan.mostPopular && (
                <div className="absolute -top-2 sm:-top-3 left-1/2 transform -translate-x-1/2 z-10">
                  <div className="flex items-center space-x-1 px-3 sm:px-3 py-1 sm:py-1.5 bg-linear-to-b from-blue-500 to-cyan-500 rounded-full text-xs sm:text-sm font-semibold shadow-lg">
              ...
              <ul className="space-y-3 sm:space-y-4 mb-6 sm:mb-8 flex-row">
                {plan.features.map((feature, featureKey) => (
                  ...
                  >
                    <div className="shrink-0 size-4 sm:size-5 rounded-full bg-blue-500/20 flex items-center justify-center mt-0.5">
                      <Check className="size-2.5 text-blue-400 sm:size-3" />
                    </div>
